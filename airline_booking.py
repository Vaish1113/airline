...
import os
conn = mysql.connector.connect(host='localhost', username='root', password='Nir@3660', database='airlines_booking')
...
def flight_data():
    ...
    query3 = "SELECT * FROM FLIGHTS WHERE AIRLINES_NAME = '{}' AND DEPARTURE = '{}' AND DESTINATION = '{}' ".format(fly,
                                                                                                                    departure,
                                                                                                                    arrival)
